...
export function Columns1() {
  ...
  const rows = [
    ...
    { icon: Wrench, term: 'Job type', d: { pt: 'o serviço que o lead procura (ex.: Deep clean, Moving clean, Standard clean). Pode vir como “-”.', en: 'the service the lead wants (e.g., Deep clean, Moving clean, Standard clean). May show as “-”.' } },
